...
// in digicard/test/helpers/test_helpers.dart.
...
/// A class which mocks [DigitalCardService].
///
/// See the documentation for Mockito's code generation for more information.
class MockDigitalCardService extends _i1.Mock
    implements _i8.DigitalCardService {
  @override
  ...
  @override
  _i6.Future<dynamic> imageDelete({required String? folderPath}) =>
      (super.noSuchMethod(
        Invocation.method(
          #imageDelete,
          [],
...
/// A class which mocks [NativeContactsService].
///
/// See the documentation for Mockito's code generation for more information.
...
class MockAuthService extends _i1.Mock implements _i17.AuthService {
  ...
  @override
  _i6.Future<dynamic> signUpWithEmail({
    required String? email,
    required String? password,
  }) =>
      (super.noSuchMethod(
  ...
  @override
  _i6.Future<dynamic> resetPassword({required String? password}) =>
      (super.noSuchMethod(
        Invocation.method(
          #resetPassword,
          [],
  ...
  @override
  _i6.Future<dynamic> resetPasswordRequest({required String? email}) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i6.Future<dynamic> signInAnonymously() => (super.noSuchMethod(
        Invocation.method(
          #signInAnonymously,
          [],
        ),
...
class MockUserService extends _i1.Mock implements _i18.UserService {
  ...
  @override
  bool get isPresent => (super.noSuchMethod(
        Invocation.getter(#isPresent),
        returnValue: false,
        returnValueForMissingStub: false,
      ) as bool);
