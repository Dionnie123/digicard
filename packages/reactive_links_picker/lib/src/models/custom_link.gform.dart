...
class CustomLinkForm implements FormModel<CustomLink> {
  ...
  String? get _valueValue => valueControl?.value;

  String? get _labelValue => labelControl?.value;

  String? get _customValue => customControl?.value;
  ...
  FormControl<String>? get valueControl => containsValue
  ...
  FormControl<String>? get customControl => containsCustom
